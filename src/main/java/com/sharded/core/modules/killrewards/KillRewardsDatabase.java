...
final class KillRewardsDatabase {

    private final ShardedCore plugin;
    private final Connection connection;
    private final Set<String> loaded = new HashSet<>();

    KillRewardsDatabase(ShardedCore plugin, File folder) throws SQLException {
        this.plugin = plugin;
        File dbFile = new File(folder, "killrewards.db");
    ...
    synchronized boolean isClaimed(UUID uuid, String rewardId) {
        ...
        try (PreparedStatement ps = connection.prepareStatement(
            ...
            plugin.getLogger().severe("Failed to read kill reward claim: " + e.getMessage());
        }
        return false;
    }
    ...
    synchronized void markClaimed(UUID uuid, String rewardId) {
        ...
        try (PreparedStatement ps = connection.prepareStatement(
            ...
            plugin.getLogger().severe("Failed to save kill reward claim: " + e.getMessage());
        }
    }
