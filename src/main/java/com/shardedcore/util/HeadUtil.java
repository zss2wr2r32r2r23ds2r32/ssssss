...
public final class HeadUtil {
    ...
    public static ItemStack parse(String raw) {
        ...
        if (value.equalsIgnoreCase("PLAYER_HEAD")) return new ItemStack(Material.PLAYER_HEAD);
    ...
    public static ItemStack playerHead(String playerName) { return namedHead(playerName); }
    ...
    public static boolean isHeadMaterial(String raw) {
        ...
        return lower.equals("player_head") || lower.startsWith("basehead-") || lower.startsWith("head:") || raw.startsWith("eyJ");
    }
}
