...
Thanks for downloading Tuff Macro!

This is Natro Macro renamed to Tuff Macro with a black and purple GUI. No other changes.
...
> [!CAUTION]
> We do **not** have a website. The only official place to download Tuff Macro is this repository and [discord.gg/natromacro][discord-link].
...
1. Download `Tuff_Macro_v#.#.#.zip` from the [latest release][latest-release-link]
2. Open `Tuff_Macro_v#.#.#` and double-click the folder inside
...
Tuff Macro is an open-source project. We greatly appreciate all contributions, whether you are helping us fix bugs or suggesting new features. If you want to get started, read our [Contributing Guidelines][contributing-link] first.
...
Tuff Macro wouldn't be possible without the help and inspiration of many extraordinary individuals.<br>
...
If Tuff Macro helped you, let us know by giving it a ⭐ $\color{yellow}{\textsf{Star}}$ on GitHub!<br>
